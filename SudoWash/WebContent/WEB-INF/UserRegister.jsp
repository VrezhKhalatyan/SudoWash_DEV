																...
																<form class="form-horizontal">        
																	<div class="form-group">
																	  ...
																	  <div class="col-md-8 col-sm-9">
																		  ...
																		  <input type="email" class="form-control" name="emailid" id="emailid" placeholder="Enter your Email ID" value="walter@gmail.com">
																		</div>
																	...
																	<div class="form-group">
																	  ...
																	  <div class="col-md-5 col-sm-8">
																		<div class="input-group">
																		  ...
																		  <input type="password" class="form-control" name="password" id="password" placeholder="Choose password (5-15 chars)" value="12345678">
																	   </div>   
																	  </div>
																	</div>
																	<div class="form-group">
																	  ...
																	  <div class="col-md-5 col-sm-8">
																		<div class="input-group">
																		  <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
																		  <input type="password" class="form-control" name="cpassword" id="cpassword" placeholder="Confirm your password" value="12345678">
																		</div>  
																	  </div>
																	</div>
																	<div class="form-group">
																	  ...
																	  <div class="col-md-8 col-sm-9">
																		<input type="text" class="form-control" name="mem_name" id="mem_name" placeholder="Enter your Name here" value="Walter Carbajal">
																	  </div>
																	</div>
																	<div class="form-group">
																	...
																	<div class="form-group">
																	  ...
																	  <div class="col-md-5 col-sm-8">
																		...
																		<input type="text" class="form-control" name="contactnum" id="contactnum" placeholder="Enter your Primary contact no." value="213-748-1234">
																		</div>
																	  </div>
																	</div>
																	<div class="form-group">
																	...
																	<div class="form-group">
																	  <div class="col-xs-offset-3 col-md-8 col-sm-9"><span><span class="label label-danger">Note:-</span> By clicking Sign Up, you agree to our <a href="#"><span class="link-back">Terms</span></a> and that you have read our <a href="#"><span class="link-back">Policy</span></a>, including our <a href="#"><span class="link-back">Cookie Use</span></a>.</span> </div>
																	</div>
																	<div class="form-group">
																		<div class="col-sm-offset-2 col-sm-10">
																	  	<a href="UserHub"> <button type="button" class="btn btn-default btn-round-lg btn-lg createAccount">Sign Up</button></a>
																	</div>
																  </div>
																</form>
															</div>
